...
{
    public static CursorController cursorControl;
    ...
    public void Move()
    {
        mousePosToWorld = Camera.main.ScreenToWorldPoint(new Vector3(Input.mousePosition.x+50, Input.mousePosition.y-50, zPos));
